...
export class InitialMigration1681393596969 implements MigrationInterface {
    name = 'InitialMigration1681393596969'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announces" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "kilometer" character varying(50) NOT NULL, "price_FIPE" character varying(50) NOT NULL, "price" character varying(50) NOT NULL, "description" character varying(50) NOT NULL, "image_cover" character varying NOT NULL, "published" character varying(50) NOT NULL, "tag" character varying(50) NOT NULL, "userId" uuid, "brandId" uuid, "colorId" uuid, "yearId" uuid, "modelId" uuid, "fuelId" uuid, "imageId" uuid, CONSTRAINT "REL_8d1f89f22698c85df1fc2da054" UNIQUE ("imageId"), CONSTRAINT "PK_9d7389225221375f560773aa115" PRIMARY KEY ("id"))`);

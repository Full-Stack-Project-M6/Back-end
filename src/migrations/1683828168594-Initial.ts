...
export class Initial1683828168594 implements MigrationInterface {
    name = 'Initial1683828168594'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announces" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "kilometer" character varying(50) NOT NULL, "price_FIPE" character varying(50) NOT NULL, "price" character varying(50) NOT NULL, "description" character varying(300) NOT NULL, "image_cover" character varying NOT NULL, "published" boolean NOT NULL DEFAULT true, "tag" boolean NOT NULL DEFAULT false, "images" text array NOT NULL, "userId" uuid, "brandId" uuid, "colorId" uuid, "yearId" uuid, "modelId" uuid, "fuelId" uuid, CONSTRAINT "PK_9d7389225221375f560773aa115" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "email" character varying(50) NOT NULL, "cpf" character varying(14) NOT NULL, "cellphone" character varying(15) NOT NULL, "date_birth" character varying(10) NOT NULL, "description" character varying(200) NOT NULL, "reset_token" character varying DEFAULT ' ', "account_type" boolean NOT NULL DEFAULT false, "password" character varying(120) NOT NULL, "isActive" boolean DEFAULT true, "deletedAt" TIMESTAMP, "addressId" uuid, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "UQ_15f2ebe082a6e43a960f9f88411" UNIQUE ("cellphone"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);

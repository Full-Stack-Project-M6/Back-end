...
import { IAnnounceCreateResponce, IAnnounceResponce } from "../interfaces/announce";

export const announceSerializer: yup.ObjectSchema<IAnnounceResponce> = yup
.object()
.shape({
...
export const announceCreateSerializer: yup.ObjectSchema<IAnnounceCreateResponce> = yup
.object()
.shape({
    id: yup.string().required(),
    kilometer: yup.string().required(),
